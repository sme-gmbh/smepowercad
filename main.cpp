...
int main(int argc, char *argv[])
{
    ...
    qSetMessagePattern("[%{time yyyyMMdd h:mm:ss.zzz}] %{if-debug}D%{endif}%{if-info}I%{endif}%{if-warning}W%{endif}%{if-critical}C%{endif}%{if-fatal}F%{endif} (%{qthreadptr}|%{threadid}) %{message} [%{category}]");
