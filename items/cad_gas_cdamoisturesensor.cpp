...
#include "cad_gas_cdamoisturesensor.h"
#include "glwidget.h"

CAD_Gas_CDAMoistureSensor::CAD_Gas_CDAMoistureSensor() : CADitem(CADitemTypes::Gas_CDAMoistureSensor)
{
...
CAD_Gas_CDAMoistureSensor::~CAD_Gas_CDAMoistureSensor()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAMoistureSensor::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAMoistureSensor::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAMoistureSensor::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdamoisturesensor.svg";
}

QString CAD_Gas_CDAMoistureSensor::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAMoistureSensor::description()
{
    return "Gas|CDA Moisture Sensor";
}

void CAD_Gas_CDAMoistureSensor::calculate()
{
...
void CAD_Gas_CDAMoistureSensor::processWizardInput()
{
...
//void CAD_Gas_CDAMoistureSensor::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAMoistureSensor::rotationOfFlange(quint8 num)
{
