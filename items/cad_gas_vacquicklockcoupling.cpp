...
#include "cad_gas_vacquicklockcoupling.h"
#include "glwidget.h"

CAD_Gas_VACQuickLockCoupling::CAD_Gas_VACQuickLockCoupling() : CADitem(CADitemTypes::Gas_VACQuickLockCoupling)
{
...
CAD_Gas_VACQuickLockCoupling::~CAD_Gas_VACQuickLockCoupling()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACQuickLockCoupling::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACQuickLockCoupling::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACQuickLockCoupling::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacquicklockcoupling.svg";
}

QString CAD_Gas_VACQuickLockCoupling::domain()
{
    return "Gas";
}

QString CAD_Gas_VACQuickLockCoupling::description()
{
    return "Gas|VAC Quick Lock Coupling";
}

void CAD_Gas_VACQuickLockCoupling::calculate()
{
...
void CAD_Gas_VACQuickLockCoupling::processWizardInput()
{
...
//void CAD_Gas_VACQuickLockCoupling::paint(GLWidget *glwidget)
//{
