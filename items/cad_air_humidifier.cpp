...
CAD_air_humidifier::~CAD_air_humidifier()
{

}

QList<CADitemTypes::ItemType> CAD_air_humidifier::flangable_items(int flangeIndex)
{
...
QString CAD_air_humidifier::description()
{
...
QMatrix4x4 CAD_air_humidifier::rotationOfFlange(quint8 num)
{
