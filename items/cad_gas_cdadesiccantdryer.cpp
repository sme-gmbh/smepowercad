...
#include "cad_gas_cdadesiccantdryer.h"
#include "glwidget.h"

CAD_Gas_CDADesiccantDryer::CAD_Gas_CDADesiccantDryer() : CADitem(CADitemTypes::Gas_CDADesiccantDryer)
{
...
CAD_Gas_CDADesiccantDryer::~CAD_Gas_CDADesiccantDryer()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDADesiccantDryer::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDADesiccantDryer::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDADesiccantDryer::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdadesiccantdryer.svg";
}

QString CAD_Gas_CDADesiccantDryer::domain()
{
    return "Gas";
}

QString CAD_Gas_CDADesiccantDryer::description()
{
    return "Gas|CDA Desiccant Dryer";
}

void CAD_Gas_CDADesiccantDryer::calculate()
{
...
void CAD_Gas_CDADesiccantDryer::processWizardInput()
{
...
//void CAD_Gas_CDADesiccantDryer::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDADesiccantDryer::rotationOfFlange(quint8 num)
{
