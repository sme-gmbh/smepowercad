...
#include "cad_gas_cdamanometer.h"
#include "glwidget.h"

CAD_Gas_CDAManometer::CAD_Gas_CDAManometer() : CADitem(CADitemTypes::Gas_CDAManometer)
{
...
CAD_Gas_CDAManometer::~CAD_Gas_CDAManometer()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAManometer::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAManometer::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAManometer::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdamanometer.svg";
}

QString CAD_Gas_CDAManometer::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAManometer::description()
{
    return "Gas|CDA Manometer";
}

void CAD_Gas_CDAManometer::calculate()
{
...
void CAD_Gas_CDAManometer::processWizardInput()
{
...
//void CAD_Gas_CDAManometer::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAManometer::rotationOfFlange(quint8 num)
{
