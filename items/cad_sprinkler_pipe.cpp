...
CAD_sprinkler_pipe::~CAD_sprinkler_pipe()
{

}

QList<CADitemTypes::ItemType> CAD_sprinkler_pipe::flangable_items(int flangeIndex)
{
...
QString CAD_sprinkler_pipe::iconPath()
{
    return ":/icons/cad_sprinkler/cad_sprinkler_pipe.svg";
}

QString CAD_sprinkler_pipe::domain()
{
    return "Sprinkler";
}

QString CAD_sprinkler_pipe::description()
{
    return "Sprinkler|Pipe";
}
