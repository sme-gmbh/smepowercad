...
#include "cad_heatcool_radiatorflange.h"
#include "glwidget.h"

CAD_HeatCool_RadiatorFlange::CAD_HeatCool_RadiatorFlange() : CADitem(CADitemTypes::HeatCool_RadiatorFlange)
{
...
CAD_HeatCool_RadiatorFlange::~CAD_HeatCool_RadiatorFlange()
{
...
QList<CADitemTypes::ItemType> CAD_HeatCool_RadiatorFlange::flangable_items(int flangeIndex)
{
...
QImage CAD_HeatCool_RadiatorFlange::wizardImage()
{
    QImage image;
...
QString CAD_HeatCool_RadiatorFlange::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_radiatorflange.svg";
}

QString CAD_HeatCool_RadiatorFlange::domain()
{
    return "HeatCool";
}

QString CAD_HeatCool_RadiatorFlange::description()
{
    return "HeatCool|Radiator Flange";
}

void CAD_HeatCool_RadiatorFlange::calculate()
{                
    boundingBox.reset();
    ...
    QVector3D position_po1 = position + matrix_rotation * QVector3D(l/2, e/2, 0.0);
    ...
    QVector3D position_po2 = position + matrix_rotation * QVector3D(l/2, -e/2, 0.0);
    ...
    QVector3D positon_con = position + matrix_rotation * QVector3D(l/2, 0.0, d/4);
    ...
    connector->wizardParams.insert("b", e);
    connector->wizardParams.insert("a", d/2);
...
void CAD_HeatCool_RadiatorFlange::processWizardInput()
{
...
//void CAD_HeatCool_RadiatorFlange::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_HeatCool_RadiatorFlange::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
