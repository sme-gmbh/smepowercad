...
#include "cad_gas_vacpipe.h"
#include "glwidget.h"

CAD_Gas_VACPipe::CAD_Gas_VACPipe() : CADitem(CADitemTypes::Gas_VACPipe)
{
...
CAD_Gas_VACPipe::~CAD_Gas_VACPipe()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACPipe::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACPipe::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACPipe::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacpipe.svg";
}

QString CAD_Gas_VACPipe::domain()
{
    return "Gas";
}

QString CAD_Gas_VACPipe::description()
{
    return "Gas|VAC Pipe";
}

void CAD_Gas_VACPipe::calculate()
{
    boundingBox.reset();
...
void CAD_Gas_VACPipe::processWizardInput()
{
...
//void CAD_Gas_VACPipe::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACPipe::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
