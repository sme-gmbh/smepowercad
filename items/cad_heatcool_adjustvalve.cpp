...
CAD_heatcool_adjustvalve::CAD_heatcool_adjustvalve() : CADitem(CADitemTypes::HeatCool_Adjustvalve)
{
...
CAD_heatcool_adjustvalve::~CAD_heatcool_adjustvalve()
{

}

QList<CADitemTypes::ItemType> CAD_heatcool_adjustvalve::flangable_items(int flangeIndex)
{
...
QString CAD_heatcool_adjustvalve::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_adjustvalve.svg";
}

QString CAD_heatcool_adjustvalve::domain()
{
    return "HeatCool";
}

QString CAD_heatcool_adjustvalve::description()
{
    return "HeatCool|Adjustvalve";
}
...
QMatrix4x4 CAD_heatcool_adjustvalve::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
