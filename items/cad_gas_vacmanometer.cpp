...
#include "cad_gas_vacmanometer.h"
#include "glwidget.h"

CAD_Gas_VACManometer::CAD_Gas_VACManometer() : CADitem(CADitemTypes::Gas_VACManometer)
{
...
CAD_Gas_VACManometer::~CAD_Gas_VACManometer()
{
...
QImage CAD_Gas_VACManometer::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACManometer::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacmanometer.svg";
}

QString CAD_Gas_VACManometer::domain()
{
    return "Gas";
}

QString CAD_Gas_VACManometer::description()
{
    return "Gas|VAC Manometer";
}

void CAD_Gas_VACManometer::calculate()
{
...
void CAD_Gas_VACManometer::processWizardInput()
{
...
//void CAD_Gas_VACManometer::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACManometer::rotationOfFlange(quint8 num)
{
