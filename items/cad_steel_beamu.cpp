...
#include "cad_steel_beamu.h"
#include "glwidget.h"

CAD_Steel_BeamU::CAD_Steel_BeamU() : CADitem(CADitemTypes::Steel_BeamU)
{
...
CAD_Steel_BeamU::~CAD_Steel_BeamU()
{
...
QList<CADitemTypes::ItemType> CAD_Steel_BeamU::flangable_items(int flangeIndex)
{
...
QImage CAD_Steel_BeamU::wizardImage()
{
    QImage image;
...
QString CAD_Steel_BeamU::iconPath()
{
    return ":/icons/cad_steel/cad_steel_beamu.svg";
}

QString CAD_Steel_BeamU::domain()
{
    return "Steel";
}

QString CAD_Steel_BeamU::description()
{
    return "Steel|Beam U";
}

void CAD_Steel_BeamU::calculate()
{                
    boundingBox.reset();
    ...
    QVector3D position_box_flangeLower = (matrix_rotation * QVector3D(l/2.0, -b/2.0, g/2.0 - a/2.0)) + position;
    ...
    QVector3D position_box_flangeUpper = (matrix_rotation * QVector3D(l/2.0, -b/2.0, a/2.0 - g/2.0)) + position;
    ...
    QVector3D position_box_web = (matrix_rotation * QVector3D(l/2.0, -s/2.0, 0.0)) + position;
...
void CAD_Steel_BeamU::processWizardInput()
{
...
QMatrix4x4 CAD_Steel_BeamU::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
...
//void CAD_Steel_BeamU::paint(GLWidget *glwidget)
//{
