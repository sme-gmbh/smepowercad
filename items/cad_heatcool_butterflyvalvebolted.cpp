...
QList<CADitemTypes::ItemType> CAD_HeatCool_ButterflyValveBolted::flangable_items(int flangeIndex)
{
...
QMatrix4x4 CAD_HeatCool_ButterflyValveBolted::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
