...
#include "cad_gas_vactank.h"
#include "glwidget.h"

CAD_Gas_VACTank::CAD_Gas_VACTank() : CADitem(CADitemTypes::Gas_VACTank)
{
...
CAD_Gas_VACTank::~CAD_Gas_VACTank()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACTank::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACTank::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACTank::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vactank.svg";
}

QString CAD_Gas_VACTank::domain()
{
    return "Gas";
}

QString CAD_Gas_VACTank::description()
{
    return "Gas|VAC Tank";
}

void CAD_Gas_VACTank::calculate()
{
...
void CAD_Gas_VACTank::processWizardInput()
{
...
//void CAD_Gas_VACTank::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACTank::rotationOfFlange(quint8 num)
{
