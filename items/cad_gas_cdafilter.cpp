...
#include "cad_gas_cdafilter.h"
#include "glwidget.h"

CAD_Gas_CDAFilter::CAD_Gas_CDAFilter() : CADitem(CADitemTypes::Gas_CDAFilter)
{
...
CAD_Gas_CDAFilter::~CAD_Gas_CDAFilter()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAFilter::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAFilter::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAFilter::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdafilter.svg";
}

QString CAD_Gas_CDAFilter::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAFilter::description()
{
    return "Gas|CDA Filter";
}

void CAD_Gas_CDAFilter::calculate()
{
...
void CAD_Gas_CDAFilter::processWizardInput()
{
...
//void CAD_Gas_CDAFilter::paint(GLWidget *glwidget)
//{
