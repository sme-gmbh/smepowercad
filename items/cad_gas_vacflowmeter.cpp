...
#include "cad_gas_vacflowmeter.h"
#include "glwidget.h"

CAD_Gas_VACFlowmeter::CAD_Gas_VACFlowmeter() : CADitem(CADitemTypes::Gas_VACFlowmeter)
{
...
CAD_Gas_VACFlowmeter::~CAD_Gas_VACFlowmeter()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACFlowmeter::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACFlowmeter::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACFlowmeter::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacflowmeter.svg";
}

QString CAD_Gas_VACFlowmeter::domain()
{
    return "Gas";
}

QString CAD_Gas_VACFlowmeter::description()
{
    return "Gas|VAC Flowmeter";
}

void CAD_Gas_VACFlowmeter::calculate()
{
...
void CAD_Gas_VACFlowmeter::processWizardInput()
{
...
//void CAD_Gas_VACFlowmeter::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACFlowmeter::rotationOfFlange(quint8 num)
{
