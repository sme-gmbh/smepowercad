...
#include "cad_gas_vachose.h"
#include "glwidget.h"

CAD_Gas_VACHose::CAD_Gas_VACHose() : CADitem(CADitemTypes::Gas_VACHose)
{
...
CAD_Gas_VACHose::~CAD_Gas_VACHose()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACHose::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACHose::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACHose::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vachose.svg";
}

QString CAD_Gas_VACHose::domain()
{
    return "Gas";
}

QString CAD_Gas_VACHose::description()
{
    return "Gas|VAC Hose";
}

void CAD_Gas_VACHose::calculate()
{
...
void CAD_Gas_VACHose::processWizardInput()
{
...
//void CAD_Gas_VACHose::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACHose::rotationOfFlange(quint8 num)
{
