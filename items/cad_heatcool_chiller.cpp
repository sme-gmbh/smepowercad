...
CAD_heatcool_chiller::CAD_heatcool_chiller() : CADitem(CADitemTypes::HeatCool_Chiller)
{
...
QList<CADitemTypes::ItemType> CAD_heatcool_chiller::flangable_items(int flangeIndex)
{
...
QString CAD_heatcool_chiller::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_chiller.svg";
}

QString CAD_heatcool_chiller::domain()
{
    return "HeatCool";
}
...
QMatrix4x4 CAD_heatcool_chiller::rotationOfFlange(quint8 num)
{
