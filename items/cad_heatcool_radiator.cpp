...
CAD_heatcool_radiator::~CAD_heatcool_radiator()
{

}

QList<CADitemTypes::ItemType> CAD_heatcool_radiator::flangable_items(int flangeIndex)
{
...
QString CAD_heatcool_radiator::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_radiator.svg";
}

QString CAD_heatcool_radiator::domain()
{
    return "HeatCool";
}
...
QMatrix4x4 CAD_heatcool_radiator::rotationOfFlange(quint8 num)
{
