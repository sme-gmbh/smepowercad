...
#include "cad_gas_cdaflowmeter.h"
#include "glwidget.h"

CAD_Gas_CDAFlowmeter::CAD_Gas_CDAFlowmeter() : CADitem(CADitemTypes::Gas_CDAFlowmeter)
{
...
CAD_Gas_CDAFlowmeter::~CAD_Gas_CDAFlowmeter()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAFlowmeter::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAFlowmeter::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAFlowmeter::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdaflowmeter.svg";
}

QString CAD_Gas_CDAFlowmeter::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAFlowmeter::description()
{
    return "Gas|CDA Flowmeter";
}

void CAD_Gas_CDAFlowmeter::calculate()
{
...
void CAD_Gas_CDAFlowmeter::processWizardInput()
{
...
//void CAD_Gas_CDAFlowmeter::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAFlowmeter::rotationOfFlange(quint8 num)
{
