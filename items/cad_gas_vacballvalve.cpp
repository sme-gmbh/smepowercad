...
#include "cad_gas_vacballvalve.h"
#include "glwidget.h"

CAD_Gas_VACBallValve::CAD_Gas_VACBallValve() : CADitem(CADitemTypes::Gas_VACBallValve)
{
...
CAD_Gas_VACBallValve::~CAD_Gas_VACBallValve()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACBallValve::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACBallValve::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACBallValve::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacballvalve.svg";
}

QString CAD_Gas_VACBallValve::domain()
{
    return "Gas";
}

QString CAD_Gas_VACBallValve::description()
{
    return "Gas|VAC Ball Valve";
}

void CAD_Gas_VACBallValve::calculate()
{
...
void CAD_Gas_VACBallValve::processWizardInput()
{
...
//void CAD_Gas_VACBallValve::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACBallValve::rotationOfFlange(quint8 num)
{
