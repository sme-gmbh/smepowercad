...
#include "cad_gas_cdadiaphragmvalve.h"
#include "glwidget.h"

CAD_Gas_CDADiaphragmValve::CAD_Gas_CDADiaphragmValve() : CADitem(CADitemTypes::Gas_CDADiaphragmValve)
{
...
CAD_Gas_CDADiaphragmValve::~CAD_Gas_CDADiaphragmValve()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDADiaphragmValve::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDADiaphragmValve::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDADiaphragmValve::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdadiaphragmvalve.svg";
}

QString CAD_Gas_CDADiaphragmValve::domain()
{
    return "Gas";
}

QString CAD_Gas_CDADiaphragmValve::description()
{
    return "Gas|CDA Diaphragm Valve";
}

void CAD_Gas_CDADiaphragmValve::calculate()
{
...
void CAD_Gas_CDADiaphragmValve::processWizardInput()
{
...
//void CAD_Gas_CDADiaphragmValve::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDADiaphragmValve::rotationOfFlange(quint8 num)
{
