...
#include "cad_gas_vacnonreturnvalve.h"
#include "glwidget.h"

CAD_Gas_VACNonReturnValve::CAD_Gas_VACNonReturnValve() : CADitem(CADitemTypes::Gas_VACNonReturnValve)
{
...
CAD_Gas_VACNonReturnValve::~CAD_Gas_VACNonReturnValve()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACNonReturnValve::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACNonReturnValve::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACNonReturnValve::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacnonreturnvalve.svg";
}

QString CAD_Gas_VACNonReturnValve::domain()
{
    return "Gas";
}

QString CAD_Gas_VACNonReturnValve::description()
{
    return "Gas|VAC Non Return Valve";
}

void CAD_Gas_VACNonReturnValve::calculate()
{
...
void CAD_Gas_VACNonReturnValve::processWizardInput()
{
...
//void CAD_Gas_VACNonReturnValve::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACNonReturnValve::rotationOfFlange(quint8 num)
{
