...
CAD_heatcool_boiler::CAD_heatcool_boiler() : CADitem(CADitemTypes::HeatCool_Boiler)
{
...
CAD_heatcool_boiler::~CAD_heatcool_boiler()
{
...
QString CAD_heatcool_boiler::description()
{
    return "Heat/Cool|Boiler";
}
...
QMatrix4x4 CAD_heatcool_boiler::rotationOfFlange(quint8 num)
{
