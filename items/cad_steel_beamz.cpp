...
#include "cad_steel_beamz.h"
#include "glwidget.h"

CAD_Steel_BeamZ::CAD_Steel_BeamZ() : CADitem(CADitemTypes::Steel_BeamZ)
{
...
CAD_Steel_BeamZ::~CAD_Steel_BeamZ()
{
...
QList<CADitemTypes::ItemType> CAD_Steel_BeamZ::flangable_items(int flangeIndex)
{
...
QImage CAD_Steel_BeamZ::wizardImage()
{
    QImage image;
...
QString CAD_Steel_BeamZ::iconPath()
{
    return ":/icons/cad_steel/cad_steel_beamz.svg";
}

QString CAD_Steel_BeamZ::domain()
{
    return "Steel";
}

QString CAD_Steel_BeamZ::description()
{
    return "Steel|Beam Z";
}

void CAD_Steel_BeamZ::calculate()
{                
    boundingBox.reset();
    ...
    QVector3D position_box_flangeLower = (matrix_rotation * QVector3D(l/2.0, b/4.0 - s/4.0, g/2.0 - a/2.0)) + position;
    ...
    box_flangeLower->wizardParams.insert("b", b/2.0 + s/2.0);
    ...
    QVector3D position_box_flangeUpper = (matrix_rotation * QVector3D(l/2.0, s/4.0 - b/4.0, a/2.0 - g/2.0)) + position;
    ...
    box_flangeUpper->wizardParams.insert("b", b/2.0 + s/2.0);
    ...
    QVector3D position_box_web = (matrix_rotation * QVector3D(l/2.0, 0.0, 0.0)) + position;
    ...
    box_web->wizardParams.insert("a", a - g*2.0);
...
void CAD_Steel_BeamZ::processWizardInput()
{
...
QMatrix4x4 CAD_Steel_BeamZ::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
...
//void CAD_Steel_BeamZ::paint(GLWidget *glwidget)
//{
