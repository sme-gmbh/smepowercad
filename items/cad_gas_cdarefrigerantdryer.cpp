...
#include "cad_gas_cdarefrigerantdryer.h"
#include "glwidget.h"

CAD_Gas_CDARefrigerantDryer::CAD_Gas_CDARefrigerantDryer() : CADitem(CADitemTypes::Gas_CDARefrigerantDryer)
{
...
CAD_Gas_CDARefrigerantDryer::~CAD_Gas_CDARefrigerantDryer()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDARefrigerantDryer::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDARefrigerantDryer::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDARefrigerantDryer::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdarefrigerantdryer.svg";
}

QString CAD_Gas_CDARefrigerantDryer::domain()
{
    return "Gas";
}

QString CAD_Gas_CDARefrigerantDryer::description()
{
    return "Gas|CDA Refrigerant Dryer";
}

void CAD_Gas_CDARefrigerantDryer::calculate()
{
...
void CAD_Gas_CDARefrigerantDryer::processWizardInput()
{
...
//void CAD_Gas_CDARefrigerantDryer::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDARefrigerantDryer::rotationOfFlange(quint8 num)
{
