...
#include "cad_gas_vacliquidseparator.h"
#include "glwidget.h"

CAD_Gas_VACLiquidSeparator::CAD_Gas_VACLiquidSeparator() : CADitem(CADitemTypes::Gas_VACLiquidSeparator)
{
...
CAD_Gas_VACLiquidSeparator::~CAD_Gas_VACLiquidSeparator()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACLiquidSeparator::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACLiquidSeparator::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACLiquidSeparator::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacliquidseparator.svg";
}

QString CAD_Gas_VACLiquidSeparator::domain()
{
    return "Gas";
}

QString CAD_Gas_VACLiquidSeparator::description()
{
    return "Gas|VAC Liquid Separator";
}

void CAD_Gas_VACLiquidSeparator::calculate()
{
...
void CAD_Gas_VACLiquidSeparator::processWizardInput()
{
...
//void CAD_Gas_VACLiquidSeparator::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACLiquidSeparator::rotationOfFlange(quint8 num)
{
