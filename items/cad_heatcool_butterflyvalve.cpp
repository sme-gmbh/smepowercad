...
CAD_heatcool_butterflyValve::CAD_heatcool_butterflyValve() : CADitem(CADitemTypes::HeatCool_ButterflyValve)
{
...
QList<CADitemTypes::ItemType> CAD_heatcool_butterflyValve::flangable_items()
{
...
QString CAD_heatcool_butterflyValve::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_butterflyvalve.svg";
}

QString CAD_heatcool_butterflyValve::domain()
{
    return "HeatCool";
}

QString CAD_heatcool_butterflyValve::description()
{
    return "Heat/Cool|Butterflyvalve";
}
