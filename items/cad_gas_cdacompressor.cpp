...
#include "cad_gas_cdacompressor.h"
#include "glwidget.h"

CAD_Gas_CDACompressor::CAD_Gas_CDACompressor() : CADitem(CADitemTypes::Gas_CDACompressor)
{
...
CAD_Gas_CDACompressor::~CAD_Gas_CDACompressor()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDACompressor::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDACompressor::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDACompressor::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdacompressor.svg";
}

QString CAD_Gas_CDACompressor::domain()
{
    return "Gas";
}

QString CAD_Gas_CDACompressor::description()
{
    return "Gas|CDA Compressor";
}

void CAD_Gas_CDACompressor::calculate()
{
...
void CAD_Gas_CDACompressor::processWizardInput()
{
...
//void CAD_Gas_CDACompressor::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDACompressor::rotationOfFlange(quint8 num)
{
