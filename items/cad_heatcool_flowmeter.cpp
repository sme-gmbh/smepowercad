...
CAD_heatcool_flowmeter::~CAD_heatcool_flowmeter()
{

}

QList<CADitemTypes::ItemType> CAD_heatcool_flowmeter::flangable_items(int flangeIndex)
{
...
QMatrix4x4 CAD_heatcool_flowmeter::rotationOfFlange(quint8 num)
{
    if(num == 1)
    {
        QMatrix4x4 m;
