...
CAD_sprinkler_zoneCheck::~CAD_sprinkler_zoneCheck()
{

}

QList<CADitemTypes::ItemType> CAD_sprinkler_zoneCheck::flangable_items(int flangeIndex)
{
...
QString CAD_sprinkler_zoneCheck::description()
{
    return "Sprinkler|ZoneCheck";
}
