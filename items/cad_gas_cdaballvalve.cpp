...
#include "cad_gas_cdaballvalve.h"
#include "glwidget.h"

CAD_Gas_CDABallValve::CAD_Gas_CDABallValve() : CADitem(CADitemTypes::Gas_CDABallValve)
{
...
CAD_Gas_CDABallValve::~CAD_Gas_CDABallValve()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDABallValve::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDABallValve::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDABallValve::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdaballvalve.svg";
}

QString CAD_Gas_CDABallValve::domain()
{
    return "Gas";
}

QString CAD_Gas_CDABallValve::description()
{
    return "Gas|CDA Ball Valve";
}

void CAD_Gas_CDABallValve::calculate()
{
...
void CAD_Gas_CDABallValve::processWizardInput()
{
...
//void CAD_Gas_CDABallValve::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDABallValve::rotationOfFlange(quint8 num)
{
