...
#include "cad_gas_cdahose.h"
#include "glwidget.h"

CAD_Gas_CDAHose::CAD_Gas_CDAHose() : CADitem(CADitemTypes::Gas_CDAHose)
{
...
CAD_Gas_CDAHose::~CAD_Gas_CDAHose()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAHose::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAHose::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAHose::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdahose.svg";
}

QString CAD_Gas_CDAHose::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAHose::description()
{
    return "Gas|CDA Hose";
}

void CAD_Gas_CDAHose::calculate()
{
...
void CAD_Gas_CDAHose::processWizardInput()
{
...
//void CAD_Gas_CDAHose::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAHose::rotationOfFlange(quint8 num)
{
