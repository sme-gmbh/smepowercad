...
#include "cad_gas_vacfilter.h"
#include "glwidget.h"

CAD_Gas_VACFilter::CAD_Gas_VACFilter() : CADitem(CADitemTypes::Gas_VACFilter)
{
...
CAD_Gas_VACFilter::~CAD_Gas_VACFilter()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACFilter::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACFilter::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACFilter::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacfilter.svg";
}

QString CAD_Gas_VACFilter::domain()
{
    return "Gas";
}

QString CAD_Gas_VACFilter::description()
{
    return "Gas|VAC Filter";
}

void CAD_Gas_VACFilter::calculate()
{
...
void CAD_Gas_VACFilter::processWizardInput()
{
...
//void CAD_Gas_VACFilter::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACFilter::rotationOfFlange(quint8 num)
{
