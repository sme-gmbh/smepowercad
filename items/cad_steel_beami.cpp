...
#include "cad_steel_beami.h"
#include "glwidget.h"

CAD_Steel_BeamI::CAD_Steel_BeamI() : CADitem(CADitemTypes::Steel_BeamI)
{
...
CAD_Steel_BeamI::~CAD_Steel_BeamI()
{
...
QList<CADitemTypes::ItemType> CAD_Steel_BeamI::flangable_items(int flangeIndex)
{
...
QImage CAD_Steel_BeamI::wizardImage()
{
    QImage image;
...
QString CAD_Steel_BeamI::iconPath()
{
    return ":/icons/cad_steel/cad_steel_beami.svg";
}

QString CAD_Steel_BeamI::domain()
{
    return "Steel";
}

QString CAD_Steel_BeamI::description()
{
    return "Steel|Beam I";
}

void CAD_Steel_BeamI::calculate()
{                
    boundingBox.reset();
    ...
    QVector3D position_box_flangeLower = (matrix_rotation * QVector3D(l/2.0, 0.0, g/2.0)) + position;
    ...
    QVector3D position_box_web = (matrix_rotation * QVector3D(l/2.0, 0.0, a/2.0)) + position;
...
void CAD_Steel_BeamI::processWizardInput()
{
...
//void CAD_Steel_BeamI::paint(GLWidget *glwidget)
//{
