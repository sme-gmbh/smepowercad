...
#include "cad_gas_vacdiaphragmvalve.h"
#include "glwidget.h"

CAD_Gas_VACDiaphragmValve::CAD_Gas_VACDiaphragmValve() : CADitem(CADitemTypes::Gas_VACDiaphragmValve)
{
...
CAD_Gas_VACDiaphragmValve::~CAD_Gas_VACDiaphragmValve()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_VACDiaphragmValve::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_VACDiaphragmValve::wizardImage()
{
    QImage image;
...
QString CAD_Gas_VACDiaphragmValve::iconPath()
{
    return ":/icons/cad_gas/cad_gas_vacdiaphragmvalve.svg";
}

QString CAD_Gas_VACDiaphragmValve::domain()
{
    return "Gas";
}

QString CAD_Gas_VACDiaphragmValve::description()
{
    return "Gas|VAC Diaphragm Valve";
}

void CAD_Gas_VACDiaphragmValve::calculate()
{
...
void CAD_Gas_VACDiaphragmValve::processWizardInput()
{
...
//void CAD_Gas_VACDiaphragmValve::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_VACDiaphragmValve::rotationOfFlange(quint8 num)
{
