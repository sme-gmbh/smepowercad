...
#include "cad_gas_cdapressureregulator.h"
#include "glwidget.h"

CAD_Gas_CDAPressureRegulator::CAD_Gas_CDAPressureRegulator() : CADitem(CADitemTypes::Gas_CDAPressureRegulator)
{
...
CAD_Gas_CDAPressureRegulator::~CAD_Gas_CDAPressureRegulator()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAPressureRegulator::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAPressureRegulator::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAPressureRegulator::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdapressureregulator.svg";
}

QString CAD_Gas_CDAPressureRegulator::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAPressureRegulator::description()
{
    return "Gas|CDA Pressure Regulator";
}

void CAD_Gas_CDAPressureRegulator::calculate()
{
...
void CAD_Gas_CDAPressureRegulator::processWizardInput()
{
...
//void CAD_Gas_CDAPressureRegulator::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAPressureRegulator::rotationOfFlange(quint8 num)
{
