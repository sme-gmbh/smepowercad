...
#include "cad_gas_cdaquicklockcoupling.h"
#include "glwidget.h"

CAD_Gas_CDAQuickLockCoupling::CAD_Gas_CDAQuickLockCoupling() : CADitem(CADitemTypes::Gas_CDAQuickLockCoupling)
{
...
CAD_Gas_CDAQuickLockCoupling::~CAD_Gas_CDAQuickLockCoupling()
{
...
QList<CADitemTypes::ItemType> CAD_Gas_CDAQuickLockCoupling::flangable_items(int flangeIndex)
{
...
QImage CAD_Gas_CDAQuickLockCoupling::wizardImage()
{
    QImage image;
...
QString CAD_Gas_CDAQuickLockCoupling::iconPath()
{
    return ":/icons/cad_gas/cad_gas_cdaquicklockcoupling.svg";
}

QString CAD_Gas_CDAQuickLockCoupling::domain()
{
    return "Gas";
}

QString CAD_Gas_CDAQuickLockCoupling::description()
{
    return "Gas|CDA Quick Lock Coupling";
}

void CAD_Gas_CDAQuickLockCoupling::calculate()
{
...
void CAD_Gas_CDAQuickLockCoupling::processWizardInput()
{
...
//void CAD_Gas_CDAQuickLockCoupling::paint(GLWidget *glwidget)
//{
...
QMatrix4x4 CAD_Gas_CDAQuickLockCoupling::rotationOfFlange(quint8 num)
{
