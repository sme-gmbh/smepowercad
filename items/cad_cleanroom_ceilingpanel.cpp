...
#include "cad_cleanroom_ceilingpanel.h"
#include "glwidget.h"

CAD_Cleanroom_CeilingPanel::CAD_Cleanroom_CeilingPanel() : CADitem(CADitemTypes::Cleanroom_CeilingPanel)
{
...
CAD_Cleanroom_CeilingPanel::~CAD_Cleanroom_CeilingPanel()
{
...
QList<CADitemTypes::ItemType> CAD_Cleanroom_CeilingPanel::flangable_items(int flangeIndex)
{
...
QImage CAD_Cleanroom_CeilingPanel::wizardImage()
{
    QImage image;
...
QString CAD_Cleanroom_CeilingPanel::iconPath()
{
    return ":/icons/cad_cleanroom/cad_cleanroom_ceilingpanel.svg";
}

QString CAD_Cleanroom_CeilingPanel::domain()
{
    return "Cleanroom";
}

QString CAD_Cleanroom_CeilingPanel::description()
{
    return "Cleanroom|Ceiling Panel";
}
