...
CAD_heatcool_heatExchanger::CAD_heatcool_heatExchanger() : CADitem(CADitemTypes::HeatCool_HeatExchanger)
{
...
QList<CADitemTypes::ItemType> CAD_heatcool_heatExchanger::flangable_items()
{
...
QString CAD_heatcool_heatExchanger::description()
{
    return "Heat/Cool|Heatexchanger";
}
