...
QList<CADitemTypes::ItemType> CAD_heatcool_controlvalve::flangable_items(int flangeIndex)
{
...
QString CAD_heatcool_controlvalve::iconPath()
{
    return ":/icons/cad_heatcool/cad_heatcool_controlvalve.svg";
}

QString CAD_heatcool_controlvalve::domain()
{
    return "HeatCool";
}

QString CAD_heatcool_controlvalve::description()
{
    return "HeatCool|Controlvalve";
}
